...
{               ?>
						<p><i class="fa fa-map-marker"></i>V.O.C. Road, Cantonment,Tiruchirappalli, TamilNadu.</p>
						<p><i class="fa fa-phone"></i> Mobile Number : 9952441875</p>
						
						<p><i class="fa fa-envelope-o"></i> Email : <?php  echo "trichyBusPass@gmail.com";}} ?> </p>
					</div> 
				</div> 
