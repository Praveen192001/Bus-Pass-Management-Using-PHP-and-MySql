...
let source='$source'.replace(/\s/g,'')
console.log(source)
let destination='$des'.replace(/\s/g,'')
...
<option value="<?php echo htmlentities($row->CategoryName);?>"><?php echo htmlentities($row->CategoryName);?></option>
 <?php } ?>
     ...
     <div class="form-group"> <label for="exampleInputEmail1">Source</label> <input type="text" name="source" value="" class="form-control" id="source" required='true'> </div>
     <div class="form-group"> <label for="exampleInputEmail1">Destination</label> <input type="text" name="destination" value="" class="form-control" id="destination" required='true'> </div>
